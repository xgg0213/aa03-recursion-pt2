...
exponent(b, 0) // 1
exponent(b, 1) // b
exponent(b, n) // exponent(b, n / 2) ** 2             [for even n] n =4 
exponent(b, n) // b * (exponent(b, (n - 1) / 2) ** 2) [for odd n] n = 5 b * (exponent(b, 2) ^2)
...
// question: how to reduce the maximum call stack size exceeded when n = 10000?
// the maximum call stack size has a certain limit, maybe 10,000? if run in vscode, it uses the resouces of the hardware, the limit depends on the resources of the calculation
debugger
console.log(advancedExponent(2, 10000))
